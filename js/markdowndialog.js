...
CKEDITOR.dialog.add( 'markdowndialog', function( editor ) {
    ...
    var oldData;
    var rootPath = CKEDITOR.plugins.getPath( 'markdown' );
    ...
    return {
        ...
        onShow: function() {
            ...
            if (typeof(toMarkdown) == 'undefined') {
                CKEDITOR.scriptLoader.load(rootPath+'/js/to-markdown.js', function() {
                    dialog.setValueOf( 'main', 'data', toMarkdown(htmlData) );
                });
            } else {
                this.setValueOf( 'main', 'data', toMarkdown(htmlData) );
            }
        ...
        onOk: ( function() {
            ...
            return function() {
                ...
                setTimeout( function() {
                    setData( that, marked(newData, {langPrefix: 'language-'}) );
                } );
